...
Revision ID: d604452e1ec2
Revises: 
Create Date: 2024-10-01 02:51:02.112510
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("token_tg"),
        sa.UniqueConstraint("web_server_port"),
    )
